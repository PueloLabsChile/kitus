---
titulo: "Desalojar a una comunidad indígena no es un problema entre privados"
bajada: "El Estado provincial no puede permanecer ausente en los conflictos judiciales donde se enfrentan los derechos de un particular y los de una comunidad mapuche. No se trata de una opción política ni de una decisión discrecional del…"
seccion: derechos
...
La entrada [Desalojar a una comunidad indígena no es un problema entre privados](https://agenciatierraviva.com.ar/desalojar-a-una-comunidad-indigena-no-es-un-problema-entre-privados/) se publicó primero en [Agencia de Noticias Tierra Viva](https://agenciatierraviva.com.ar).

---

*Publicado originalmente en [Agencia Tierra Viva](https://agenciatierraviva.com.ar/desalojar-a-una-comunidad-indigena-no-es-un-problema-entre-privados/) el 28 de agosto de 2026. Reproducido por Kitus bajo licencia [CC BY 2.5 AR](https://creativecommons.org/licenses/by/2.5/ar/). El texto no fue modificado.*
